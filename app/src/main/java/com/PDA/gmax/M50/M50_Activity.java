...
//    private Button btn_save, btn_query, btn_menu;
    ...
    MaterialButton btn_m51, btn_m52, btn_m53,btn_m54;
//    ExtendedFloatingActionButton btn_menu;

    //== Grant 관련 변수 ==//
    private String ADMIN_CHK = "N", W_IN = "N", M51 = "N", M52 = "N", M53 = "N",M54 = "N";     //Grant

    //== ActivityForResult 관련 변수 ==//
    private final int M51_DTL_REQUEST_CODE = 1, M52_DTL_REQUEST_CODE = 2
            , M53_DTL_REQUEST_CODE = 3,M54_QUERY_REQUEST_CODE=4;
    ...
    private void initializeView() {
        ...
        btn_m51        = findViewById(R.id.btn_Seal_Stored);           // 1. Seal 원단 입고
        btn_m52        = findViewById(R.id.btn_Mat_Stored);            // 2. Mat 원단 투입
        btn_m53        = findViewById(R.id.btn_Fabric_Pro_Input);      // 3. 원단 투입
        btn_m54        = findViewById(R.id.btn_Fabric_Stock);          // 4. 재고현황
        ...
        View.OnClickListener clickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (v == btn_m51) {     // MAT원단 입고
                    if (start_grant("M51")) {
                        String sMenuName = "메뉴 > 원단관리 > MAT 원단 입고";
                    ...
                    if (start_grant("M52")) {
                        String sMenuName = "메뉴 > 원단 관리 > SEAL 원단 입고";
                    ...
                    if (start_grant("M54")) {
                        ...
                        Intent intent = TGSClass.ChangeView(getPackageName(), M54_QUERY_Activity.class);
                        intent.putExtra("MENU_ID", "M54");
                        intent.putExtra("MENU_NM", sMenuName);
                        intent.putExtra("MENU_REMARK", vMenuRemark);
                        intent.putExtra("START_COMMAND", vStartCommand);
                        startActivityForResult(intent, M54_QUERY_REQUEST_CODE);
                    }
                }
        ...
        try {
            ...
            if (ADMIN_CHK.equals("N") && W_IN.equals("N")) {
                if (MenuID.equals("M51") && M51.equals("N")) {
                    TGSClass.AlertMessage(getApplicationContext(), "MAT 원단 입고 메뉴에 대한 접속 권한이 없습니다.");
                    return false;
                } else if (MenuID.equals("M52") && M52.equals("N")) {
                    TGSClass.AlertMessage(getApplicationContext(), "SEAL 원단 재고 메뉴에 대한 접속 권한이 없습니다.");
                    return false;
