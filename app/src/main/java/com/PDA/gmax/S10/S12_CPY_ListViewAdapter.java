...
public class S12_CPY_ListViewAdapter extends BaseAdapter {

    private ArrayList<S12_PKG> listViewItem = new ArrayList<S12_PKG>();

    public S12_CPY_ListViewAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_view_s12_cpy, parent, false);
        }
