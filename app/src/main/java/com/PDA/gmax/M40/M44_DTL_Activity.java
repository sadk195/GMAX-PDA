...
public class M44_DTL_Activity extends BaseActivity {
    ...
    private final int M44_DTL_REQUEST_CODE = 0;
    int vIdx=-1;

    //== ListView Adapter 선언 ==//
    M44_DTL_ListViewAdapter ListViewAdapter; //데이터를 완전히 초기화 하는것이 아니라 수정처리 하기때문에 전역 선언

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_m44_dtl);
    ...
    private void initializeView() {
        ...
        //== Adapter 선언 ==//
        ListViewAdapter = new M44_DTL_ListViewAdapter();
    ...
    private void Scan_QR(){
        try {
            ...
            if(err.equals("")){
                ...
                SetSaveTempData(vItem.QR_VALUE_ALL,"M44");
    ...
    private void SetTempQR(){
        List<String> stringList = GetTempData("M44");
