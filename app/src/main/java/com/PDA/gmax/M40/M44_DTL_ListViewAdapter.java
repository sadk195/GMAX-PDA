...
public class M44_DTL_ListViewAdapter extends BaseAdapter {

    private ArrayList<M40_DTL> listViewItem = new ArrayList<M40_DTL>();

    public M44_DTL_ListViewAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_view_m44_dtl, parent, false);
        }
